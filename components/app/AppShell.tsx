...
const ICONS = {
  ...
  docs: "M4 19.5A2.5 2.5 0 0 1 6.5 17H20M4 19.5A2.5 2.5 0 0 0 6.5 22H20V2H6.5A2.5 2.5 0 0 0 4 4.5v15zM9 7h7M9 11h7",
    ...
    <div style={{ display: "flex", height: "100dvh", overflow: "hidden" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: collapsed ? "center" : "space-between", padding: "2px 6px 14px" }}>
          <Link href="/home" style={{ display: "flex", alignItems: "center", gap: 9 }}>
            <Logo size={24} />
