  ...
  return (
    <>
      ...
      <Steps items={[
        ...
        { title: "Mode + scale", body: "The mode is chosen BEFORE casting, on the population stage: leave ✦ AUTO and the director recommends a choreography with a written rationale (tagged ✦ DIRECTOR'S PICK), or pick any of the seven yourself and the panel is DESIGNED for it — Tribunal casts genuine opposing benches, Desk casts section owners. Changing the mode after a cast persists instantly when the cast still fits, and offers a one-click RE-CAST when it doesn't (switching to Tribunal, or to/from the research modes). The run-config cards stay in sync as the legend." },
  ...
  return (
    <>
      ...
      <Steps items={[
        ...
        { title: "Cast the population", body: "Pick the interaction mode first (or leave ✦ AUTO — the director decides and shows its rationale), then AUTO-CAST and watch the theater. The panel is designed FOR the chosen choreography. Review the leads, adjust composition or counts, generate the crowd and browse it. Change the mode later and it either persists instantly or offers a one-click re-cast when the cast no longer fits." },
