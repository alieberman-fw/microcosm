  ...
  return (
    <>
      ...
      <Steps items={[
        ...
        { title: "Launch and watch", body: "One button: ▶ LAUNCH THE RUN. The crowd materializes automatically first if it hasn't been generated. Posts stream in with document citations, reply lines connect who's answering whom on the network canvas, and the crowd is polled between rounds — the whole transcript persists." },
        { title: "Synthesize the report", body: "When the run completes, hit SYNTHESIZE THE REPORT and watch the progress strip stream its stages — then read it. Reports are permanent, versioned run records: find them all in the Reports tab (search, verdict filters, dates), and delete any version from the card's ⋯ menu." },
      ]} />
