...
- [ ] **⟶ NEXT: Agora engine + all seven modes + crowd sentiment polling** — swarms architectures for all seven modes in `engine/`, events over Supabase Realtime into the (already-built) run screen, crowd sentiment polls between rounds
